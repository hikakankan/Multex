...
class WYFont
{
    ...
    public constructor(font, graph, use_image, image_settings) {
        this.font = font;
        this.graph = graph;
        this.use_image = use_image;
        this.image_settings = image_settings;
...
class WYColor
{
    ...
    public constructor(red, green, blue) {
        this.red = red;
        this.green = green;
        this.blue = blue;
        this.gradient = null;
    ...
    public getRGB(brightness, positive)
	{
		var c = this.getShadowColor(brightness, positive);
		return c.getRGBColor();
	}

    public getShadowColor(brightness, positive)
	{
		var r;
		var g;
		var b;
    ...
    public getVGradient(gc, height, color2)
	{
    ...
    public getGradient(gc, x, y, width, height, color2)
	{
    ...
    public getGradient2(gc, x, y, width, height, color2)
	{
		var grad  = gc.createLinearGradient(x, y, x + width, y + height);
		grad.addColorStop(0, this.getRGBColor());
